...
# axs[0].plot(diag1['T'], 2*np.sin(2*np.pi*diag1['T']/44640))
axs[0].plot(diag1['T'], eps1m, label='100 m lower interface')
axs[0].plot(diag6['T'], eps6m, label='normal interface')
axs[1].plot(diag1['T'], itr.cumtrapz(eps1m, diag1['T'], initial=0))
axs[1].plot(diag6['T'], itr.cumtrapz(eps6m, diag6['T'], initial=0))
axs[0].legend()
